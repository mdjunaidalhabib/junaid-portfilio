...
export default function Stats() {
  ...
  return (
    <div ref={ref} style={{ background: 'linear-gradient(135deg,#f0fdf4,#f8fafc)', borderTop: '1px solid rgba(34,197,94,.12)', borderBottom: '1px solid rgba(34,197,94,.1)' }}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 grid grid-cols-2 md:grid-cols-4 gap-4">
        {stats.map((s, i) => (
          <div key={i} className="stat-card">
            ...
            <div style={{ fontSize: '0.82rem', color: '#64748b', marginTop: '5px' }}>{s.label}</div>
